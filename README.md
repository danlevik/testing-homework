...
Пожалуйста, выполняйте тесты через hermione gui (все тесты написаны через hermione) и если они падают, пробуйте их ретраить по отдельности друг от друга, они могут накладываться друг на друга
