# От выполняющего домашку

Пожалуйста, выполняйте тесты через hermione gui и если они падают, пробуйте их ретраить по отдельности друг от друга, они могут накладываться друг на друга
